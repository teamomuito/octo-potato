...
object Access {
    ...
    /** What to ask for. Notifications tag along so tidy-up reminders can show up. */
    fun toRequest(): Array<String> = when {
        Build.VERSION.SDK_INT >= 34 -> arrayOf(READ_MEDIA_IMAGES, READ_MEDIA_VISUAL_USER_SELECTED, POST_NOTIFICATIONS)
        Build.VERSION.SDK_INT >= 33 -> arrayOf(READ_MEDIA_IMAGES, POST_NOTIFICATIONS)
